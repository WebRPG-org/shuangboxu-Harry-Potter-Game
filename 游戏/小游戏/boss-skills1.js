...
// 剧情：哈利詹姆为了就莉莉与斯莱特林们决战（这些技能都是斯莱特林boss的）
...
(function(){
  ...
  function bossBurst(b){
    ...
    showMessageTransient(b.enraged ? '斯莱特林首领 进入 摄魂狂暴，释放 致命弹幕！' : '斯莱特林首领 使用了 追踪弹幕！', 900);
  }
  ...
  function bossCone(b){
    ...
    showMessageTransient(b.enraged ? '斯莱特林首领 疯狂发射 死亡射线！' : '斯莱特林首领 发射了 死亡射线！', 900);
  }
...
//     showMessageTransient(b.enraged ? '斯莱特林首领 狂暴召唤了 更多男朋友！' : '斯莱特林首领召唤了 她的男朋友们！', 900);
//   }
  ...
  function bossTeleport(b){
    ...
    showMessageTransient('斯莱特林首领 瞬移！', 700);
  }
  ...
  function bossDash(b){
    ...
    showMessageTransient(b.enraged ? '斯莱特林首领 疯狂突进！' : '斯莱特林首领 突进！', 700);
  }
  ...
  function bossShield(b){
    ...
    showMessageTransient('斯莱特林首领 启动 结界（护盾）！', 900);
  }
...
//       });
//     }
//     showMessageTransient(b.enraged ? '警报！斯莱特林首领 进入 摄魂狂暴，准备 阿瓦达索命咒！' : '警告！斯莱特林首领 正在蓄力 阿瓦达索命咒！', warnMs);
...
//   }
  ...
  function bossTrySpawnMinions(b){
    ...
    if(t >= b.nextMinionAt){
      ...
      showMessageTransient(b.enraged ? '斯莱特林首领 在狂暴中召唤了更多男朋友！' : '斯莱特林首领召唤了 她的男朋友们！', 700);
    }
  }
  ...
  function bossEnterEnrage(b){
    ...
    showMessageTransient('斯莱特林首领 进入 摄魂狂暴！哈利詹姆为了就莉莉与斯莱特林们决战，小心！', 1400);
  }
