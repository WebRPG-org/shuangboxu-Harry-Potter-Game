...
(function(){
  ...
  function bossBurst(b){
    ...
    showMessageTransient(b.enraged ? '斯内普 进入 摄魂狂暴，释放 致命弹幕！' : '斯内普 使用了 追踪弹幕！', 900);
  }
  ...
  function bossCone(b){
    ...
    showMessageTransient(b.enraged ? '斯内普 疯狂发射 死亡射线！' : '斯内普 发射了 死亡射线！', 900);
  }
  ...
  function bossSummon(b){
    ...
    showMessageTransient(b.enraged ? '斯内普 狂暴召唤了 更多斯莱特林们！' : '斯内普召唤了 斯莱特林们！', 900);
  }
  ...
  function bossTeleport(b){
    ...
    showMessageTransient('斯内普 瞬移！', 700);
  }
  ...
  function bossDash(b){
    ...
    showMessageTransient(b.enraged ? '斯内普 疯狂突进！' : '斯内普 突进！', 700);
  }
  ...
  function bossShield(b){
    ...
    showMessageTransient('斯内普 启动 结界（护盾）！', 900);
  }
  ...
  function bossAvada(b){
    ...
    showMessageTransient(b.enraged ? '警报！斯内普进入 摄魂狂暴，准备 阿瓦达索命咒！' : '警告！斯内普正在蓄力 阿瓦达索命咒！', warnMs);
  ...
  function bossTrySpawnMinions(b){
    ...
    if(t >= b.nextMinionAt){
      ...
      showMessageTransient(b.enraged ? '斯内普 在狂暴中召唤了更多斯莱特林！' : '斯内普召唤了 斯莱特林们！', 700);
    }
  }
  ...
  function bossEnterEnrage(b){
    ...
    showMessageTransient('斯内普进入 摄魂狂暴！小心！', 1400);
  }
