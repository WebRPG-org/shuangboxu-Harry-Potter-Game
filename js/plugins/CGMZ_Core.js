 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds a new title window class, which is a simple
 * window for displaying a title for a scene that I will begin adding to my
 * plugins with their own custom scenes.
 *
 * Version 1.30.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.30.0";
CGMZ.Core = {};
...
//-----------------------------------------------------------------------------
// Make sure x and y are whole numbers, seems to be needed
//-----------------------------------------------------------------------------
const alias_CGMZCore_WindowBase_drawIcon = Window_Base.prototype.drawIcon;
Window_Base.prototype.drawIcon = function(iconIndex, x, y) {
    alias_CGMZCore_WindowBase_drawIcon.call(this, iconIndex, Math.floor(x), Math.floor(y));
};
//=============================================================================
// Window_Selectable
//-----------------------------------------------------------------------------
